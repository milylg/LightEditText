...
abstract public class Effect<T> {
    ...
    abstract public boolean existsInSelection(InputText editor);

    abstract public T valueInSelection(InputText editor);

    abstract public void applyToSelection(InputText editor, T add);
}
